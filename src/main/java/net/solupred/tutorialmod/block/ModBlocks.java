package net.solupred.tutorialmod.block;
...
import net.solupred.tutorialmod.block.custom.EggplantCropBlock;
import net.solupred.tutorialmod.block.custom.JumpyBlock;
import net.solupred.tutorialmod.block.custom.TanzaniteLampBlock;
import net.solupred.tutorialmod.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block TANZANITE_ORE = registerBlock("tanzanite_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(3f).requiresTool(), UniformIntProvider.create(3,7)), ModItemGroup.TANZANITE);
